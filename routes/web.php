...
use App\Http\Controllers\backend\TipsAndTrickController as BackendTipsController;
...
use App\Http\Controllers\TipsAndTrickController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:1')->group(function () {
        ...
        Route::prefix('backend')->group(function () {
            ...
            // Type
            Route::get('/type/create', [BackendTypeController::class, 'create'])->name('backend.type.create');
            Route::post('/type/store', [BackendTypeController::class, 'store'])->name('backend.type.store');
            Route::get('/type/{type}/edit', [BackendTypeController::class, 'edit'])->name('backend.type.edit');
            Route::put('/type/{type}', [BackendTypeController::class, 'update'])->name('backend.type.update');
            Route::delete('bakcend/type/{type}', [BackendTypeController::class, 'destroy'])->name('backend.type.destroy');
            Route::get('/type', [BackendTypeController::class, 'index'])->name('backend.type.index');

            // Brand
            Route::get('/brand/create', [BackendBrandController::class, 'create'])->name('backend.brand.create');
            Route::post('/brand/store', [BackendBrandController::class, 'store'])->name('backend.brand.store');
            Route::get('/brand/{brand}/edit', [BackendBrandController::class, 'edit'])->name('backend.brand.edit');
            Route::put('/brand/{brand}', [BackendBrandController::class, 'update'])->name('backend.brand.update');
            Route::delete('bakcend/brand/{brand}', [BackendBrandController::class, 'destroy'])->name('backend.brand.destroy');
            Route::get('/brand', [BackendBrandController::class, 'index'])->name('backend.brand.index');

            // Blog
            Route::get('/blog/create', [BackendBlogController::class, 'create'])->name('backend.blog.create');
            Route::post('/blog/store', [BackendBlogController::class, 'store'])->name('backend.blog.store');
            Route::get('/blog/{blog}/edit', [BackendBlogController::class, 'edit'])->name('backend.blog.edit');
            Route::put('/blog/{blog}', [BackendBlogController::class, 'update'])->name('backend.blog.update');
            Route::delete('backend/blog/{blog}', [BackendBlogController::class, 'destroy'])->name('backend.blog.destroy');
            ...
            Route::delete('/tips-and-trick/{tipsAndTrick}', [BackendTipsController::class, 'destroy'])->name('backend.tipsAndTrick.destroy');
            Route::get('/tips-and-trick', [BackendTipsController::class, 'index'])->name('backend.tipsAndTrick.index');
            ...
            // Vehicle
            Route::get('/vehicle/create', [BackendVehicleController::class, 'create'])->name('backend.vehicle.create');
            Route::post('/vehicle/store', [BackendVehicleController::class, 'store'])->name('backend.vehicle.store');
            Route::get('/vehicle/{vehicle}/edit', [BackendVehicleController::class, 'edit'])->name('backend.vehicle.edit');
            Route::put('/vehicle/{vehicle}', [BackendVehicleController::class, 'update'])->name('backend.vehicle.update');
            Route::delete('backend/vehicle/{vehicle}', [BackendVehicleController::class, 'destroy'])->name('backend.vehicle.destroy');
            Route::get('/vehicle', [BackendVehicleController::class, 'index'])->name('backend.vehicle.index');

            // Affiliate Link
            Route::get('/affiliate/create/{vehicle}', [AffiliateController::class, 'create'])->name('backend.affiliate.create');
            Route::post('/affiliate/store/{vehicle}', [AffiliateController::class, 'store'])->name('backend.affiliate.store');
            Route::get('/affiliate/{affiliate}/{vehicle}/edit', [AffiliateController::class, 'edit'])->name('backend.affiliate.edit');
            Route::put('/affiliate/{affiliate}', [AffiliateController::class, 'update'])->name('backend.affiliate.update');
            Route::delete('backend/affiliate/{affiliate}', [AffiliateController::class, 'destroy'])->name('backend.affiliate.destroy');
            Route::get('/affiliate/{vehicle}', [AffiliateController::class, 'show'])->name('backend.affiliate.show');

            // Marketplace
            Route::get('/marketplace/create', [MarketplaceController::class, 'create'])->name('backend.marketplace.create');
            Route::post('/marketplace/store', [MarketplaceController::class, 'store'])->name('backend.marketplace.store');
            Route::get('/marketplace/{marketplace}/edit', [MarketplaceController::class, 'edit'])->name('backend.marketplace.edit');
            Route::put('/marketplace/{marketplace}', [MarketplaceController::class, 'update'])->name('backend.marketplace.update');
            Route::delete('backend/marketplace/{marketplace}', [MarketplaceController::class, 'destroy'])->name('backend.marketplace.destroy');
            Route::get('/marketplace', [MarketplaceController::class, 'index'])->name('backend.marketplace.index');

            // Comment
            Route::put('/comment/moderate-name/{comment}', [BackendCommentController::class, 'moderateName'])->name('backend.comment.moderate.name');
            Route::put('/comment/moderate-comment/{comment}', [BackendCommentController::class, 'moderateComment'])->name('backend.comment.moderate.comment');
            Route::delete('/comment/{comment}', [BackendCommentController::class, 'destroy'])->name('backend.comment.destroy');
            Route::get('/comment', [BackendCommentController::class, 'index'])->name('backend.comment.index');
        });
    });
});
...
Route::get('/berita/tips-and-trick', [TipsAndTrickController::class, 'index'])->name('tips.index');
