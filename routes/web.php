...
Route::middleware('auth')->group(function () {
        ...
        Route::middleware('role:1')->group(function () {
                ...
                Route::prefix('backend')->group(function () {
                        ...
                        // Tips and Trick
                        Route::post('/tips-and-trick/store/{blog}', [ BackendTipsController::class, 'store'])
                                ->name('backend.tipsAndTrick.store');
                        Route::delete('/tips-and-trick/{tipsAndTrick}', [BackendTipsController::class, 'destroy'])
                                ->name('backend.tipsAndTrick.destroy');
                        Route::get('/tips-and-trick', [ BackendTipsController::class, 'index'])
