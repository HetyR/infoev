    ...
    <div class="bg-gradient-to-b from-gray-100 to-gray-50 min-h-screen py-20">
        <div class="container mx-auto px-4 sm:px-6 lg:px-10">
            ...
            <div class="mb-12 text-center">
                <h1 class="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4 tracking-tight">Favorite Vehicles</h1>
                <p class="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">Discover and manage your curated collection of electric vehicles</p>
            </div>

            @if (count($informasiKendaraan) > 0)
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8">
                    @foreach ($informasiKendaraan as $kendaraan)
                        <div class="relative bg-white rounded-2xl shadow-md border border-gray-200 hover:shadow-xl hover:scale-105 transition-all duration-300 ease-out group overflow-hidden">
                            <!-- Vehicle Image -->
                            <div class="relative bg-gray-100 aspect-square min-h-[200px] overflow-hidden">
                                <a href="{{ route('vehicle.show', ['vehicle' => $kendaraan['slug']]) }}"
                                   class="block h-full">
                                    ...
                                    <div class="absolute inset-0 bg-gradient-to-br from-gray-200 to-gray-300 hidden items-center justify-center">
                                        <div class="text-center">
                                            ...
                                            <p class="text-gray-600 text-sm font-medium">Image Not Available</p>
                                        </div>
                                    </div>
                                    <!-- Hover overlay -->
                                    <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pointer-events-none">
                                        <span class="bg-white text-gray-900 px-4 py-2 rounded-full text-sm font-semibold mb-4 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300 shadow-sm">
                                            View Details
                                        </span>
                                    </div>
                                </a>
                                ...
                                <div class="flex items-start justify-between gap-4">
                                    <div class="flex-1 min-w-0">
                                        <h3 class="font-bold text-lg text-gray-900 truncate mb-1">
                                            {{ $kendaraan['merek'] ?? 'Unknown Brand' }}</h3>
                                        <p class="text-gray-600 text-sm truncate">
                                            {{ $kendaraan['nama'] ?? 'Unknown Model' }}</p>
                                    </div>
                                    <!-- Remove Button -->
            ...
            @else
                ...
                <div class="text-center py-24">
                    <div class="max-w-lg mx-auto">
                        ...
                        <h3 class="text-3xl font-bold text-gray-800 mb-4">No Favorite Vehicles Yet</h3>
                        <p class="text-gray-600 text-lg mb-8 leading-relaxed">Start building your dream EV collection by exploring our wide range of electric vehicles!</p>
                        <a href="{{ url('/') }}"
