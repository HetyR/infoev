    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-8 text-center">
            ...
            <p class="text-gray-600 max-w-2xl mx-auto">
                Discover and manage your collection of preferred electric vehicles
            </p>
        </div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                @foreach ($informasiKendaraan as $kendaraan)
                    <div class="bg-white rounded shadow-sm border border-gray-100 hover:shadow-md hover:border-gray-200 transition-all duration-300 overflow-hidden group">
                        ...
                        <!-- Vehicle Image -->
                        <div class="relative bg-gray-50 aspect-square min-h-[200px] overflow-hidden">
                            <a href="{{ route('vehicle.show', ['vehicle' => $kendaraan['slug']]) }}" class="block h-full">
                                ...
                                <div class="placeholder absolute inset-0 bg-gradient-to-br from-gray-100 to-gray-200 hidden items-center justify-center z-0">
                                ...
                                <!-- Hover overlay -->
                                <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-20 transition-all duration-300 flex items-center justify-center pointer-events-none z-20">
        ...
        @else
            ...
            <div class="text-center py-16">
                <div class="max-w-md mx-auto">
                    ...
                    <p class="text-gray-600 mb-6">You haven't added any vehicles to your favorites yet. Start exploring our collection to find vehicles you love!</p>
