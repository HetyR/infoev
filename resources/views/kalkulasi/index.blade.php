<x-layouts.main>
    ...
    <section class="max-w-6xl mx-auto px-4 py-8">
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="p-6">
                <form id="kalkulasiForm" class="mb-8">
                    <div class="space-y-6">
                        <div>
                            <label for="vehicle" class="block text-sm font-medium text-gray-700 mb-1">Model Kendaraan</label>
                            <select class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" name="vehicle" id="vehicle" required>
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-4">
                                <input type="range" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer" min="1" max="300" id="rata_rata_berkendara" value="30">
                                <div class="w-32">
                                    <input type="text" id="rata_rata_display" class="w-full px-3 py-2 border border-gray-300 rounded-md text-right" value="30 KM" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-4">
                                <input type="range" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer" min="1000" max="2600" step="5" id="harga_listrik" value="1445">
                                <div class="w-32">
                                    <input type="text" id="harga_listrik_display" class="w-full px-3 py-2 border border-gray-300 rounded-md text-right" value="Rp 1445 KWH" readonly>
                                </div>
                            </div>
                        </div>
                ...
                <div id="hasilKalkulasi" class="hidden bg-gray-50 rounded-lg p-6 border border-gray-200">
                    ...
                    <div id="hasilDetail" class="space-y-3"></div>
                </div>
            </div>
        </div>
    </section>
