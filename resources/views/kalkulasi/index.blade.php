...
<x-layouts.main>
    ...
    <section class="max-w-6xl mx-auto px-4 py-8">
        <div class="bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden">
            <div class="bg-gradient-to-r from-blue-700 to-blue-900 px-6 py-4 rounded-t-lg">
            ...
            <div class="p-6 space-y-6">
                <form id="kalkulasiForm" class="space-y-6">
                    <div>
                        ...
                        <select id="vehicle" name="vehicle" required
                                class="tom-select w-full border border-gray-300 rounded-md shadow-sm text-sm focus:ring-2 focus:ring-blue-600 focus:border-blue-600">
                    ...
                    <div>
                        <button type="submit"
                                class="w-full md:w-auto bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-2 rounded-md shadow-sm transition">
                            Hitung
                        </button>
                    </div>
                </form>
                ...
                <div id="hasilKalkulasi" class="hidden bg-gray-50 rounded-lg p-6 border border-gray-200">
                    ...
                    <div id="hasilDetail" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4"></div>
                </div>
            </div>
        </div>
    </section>
