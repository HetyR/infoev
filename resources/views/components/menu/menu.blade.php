        ...
        <div class="flex">
            ...
            <li>
                <a href="{{ route('brand.index') }}"
                    class="block px-8 py-4 hover:bg-purple-900 hover:text-white">MEREK</a>
            </li>
            <li>
            ...
            <li>
                <a href="{{ route('compare.index') }}"
                    class="block px-8 py-4 hover:bg-purple-900 hover:text-white">COMPARE</a>
            </li>
            <li>
                <a href="{{ route('kalkulasi.index') }}" class="block px-8 py-4 hover:bg-purple-900 hover:text-white">
                    KALKULASI EV
                </a>
            </li>
                ...
                @if (auth()->user()->role == 1)
                    <li>
                        <a href="{{ route('backend.dashboard') }}"
                            class="block px-8 py-4 hover:bg-purple-900 hover:text-white">DASHBOARD</a>
                    </li>
                @endif
            @endauth
            {{-- <li>
